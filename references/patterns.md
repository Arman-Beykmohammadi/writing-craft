...
- **Looks like:** (a) citation markup: `citeturn0search0`, `contentReference[oaicite:0]{index=0}`, `oai_citation`, `[attached_file:1]`, `grok_card`; (b) AI-referrer tracking parameters in URLs: `utm_source=chatgpt.com`, `utm_source=copilot.com`, `utm_source=openai`, `utm_source=claude.ai`, `utm_source=perplexity.ai`, `referrer=grok.com`; (c) German Wikipedia's "gehe zu Suche Nr." style leftovers.
- **Guard:** none; but keep the URL itself and any functional parameters (`?page=2`, `?v=4`).
- **Fix:** strip every markup token and every AI-referrer parameter. If the user supplies the intended reference, insert it; otherwise flag the citation gap. Never invent a reference.
- **From:** A-citation-markup-leaks, A-ai-url-params, W.
Check (en): citeturn | contentReference[oaicite | oai_citation | [attached_file: | grok_card | utm_source=chatgpt.com | utm_source=copilot.com | utm_source=openai | utm_source=claude.ai | utm_source=perplexity.ai | referrer=grok.com
...
- **From:** A-curly-quotation-marks, A-marks-pass, A-quotes-infer, H-21, N (German marks).
